...
"""
@dispatcher.add_method
def SetMovement(velocity, direction, angular_rate):
    car.set_velocity(velocity, direction, angular_rate)
    return (True, (velocity, direction, angular_rate), 'SetMovement')
#####################################################################################################################
